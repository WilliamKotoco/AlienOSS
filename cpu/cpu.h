...
///  @brief Executes a memory unload syscall
///  @param process the process that made the syscall
///  @details Makes the process wait, executes a segment unload
///  and, after that, a memory interruption
